const errors = {
  "genericError": "There was an error!\nPlease send the following to a PixelBot dev (<@687745885488414833>) and tell them what command you used (including arguments). Note that this might be an upstream Cytrus-RE issue, if so try reporting it there aswell.\n---------------------------------------------------------------------------------------------------------------------\n",
